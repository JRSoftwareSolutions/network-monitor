...
from src.monitoring.logger import LOG_MAINTENANCE_INTERVAL_SECONDS

SERVER_STARTUP_TIMEOUT_SECONDS = 15.0
SERVER_SHUTDOWN_JOIN_SECONDS = LOG_MAINTENANCE_INTERVAL_SECONDS + 5
...
def main() -> None:
    ...
    if not _wait_until_ready(url, server_thread):
        ...
        server_thread.join(timeout=SERVER_SHUTDOWN_JOIN_SECONDS)
        _show_error(
